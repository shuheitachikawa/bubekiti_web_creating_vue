...
new Vue({
  ...
  head: {
    ...
    meta: [
      ...
      { property: 'twitter:site', content: '@bubekiti' },
      { property: 'twitter:domain', content: 'bubekiti.com' },
      { property: 'twitter:title', content: 'Bubekiti Web creating | 神奈川県秦野市のWeb制作フリーランス' },
